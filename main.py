...
def run_agent():
    ...
    # Modo simulação local, caso não haja conexão gRPC real ainda:
    # Vamos simular um documento chegando
    simulated_event_text = """
    ...
    logging.info("Processando documento desestruturado simulado...")
    
    # 1. Parsing (Diretriz I)
    parsed_doc = parse_document(simulated_event_text, source_event_id="01JX_CONTRATO_JUNTA_504")
